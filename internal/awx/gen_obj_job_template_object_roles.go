...
func NewJobTemplateObjectRolesDataSource() datasource.DataSource {
	return &jobTemplateObjectRolesDataSource{DataSourceBase: framework.DataSourceBase{ProviderBase: framework.ProviderBase{TypeName: "job_template_object_roles", Endpoint: "/api/v2/job_templates/%d/object_roles/"}}}
}
...
func (o *jobTemplateObjectRolesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	data, d := framework.ReadRequest(ctx, o.Client, endpoint, "JobTemplate/ObjectRoles")
