...
func NewHostObjectRolesDataSource() datasource.DataSource {
	return &hostObjectRolesDataSource{DataSourceBase: framework.DataSourceBase{ProviderBase: framework.ProviderBase{TypeName: "host_object_roles", Endpoint: "/api/v2/hosts/%d/object_roles/"}}}
}
...
func (o *hostObjectRolesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	data, d := framework.ReadRequest(ctx, o.Client, endpoint, "Host/ObjectRoles")
