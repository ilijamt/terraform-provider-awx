		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("awx_settings_jobs.zero_defaults", "default_job_timeout", "0"),
					resource.TestCheckResourceAttr("awx_settings_jobs.zero_defaults", "ansible_fact_cache_timeout", "0"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("awx_settings_jobs.zero_defaults", "default_job_timeout", "30"),
					resource.TestCheckResourceAttr("awx_settings_jobs.zero_defaults", "ansible_fact_cache_timeout", "120"),
					resource.TestCheckResourceAttr("awx_settings_jobs.zero_defaults", "schedule_max_jobs", "25"),
					resource.TestCheckResourceAttr("awx_settings_jobs.zero_defaults", "max_forks", "0"),
				),
			},
			{
				Config: providerHeader(t) + cfg,
