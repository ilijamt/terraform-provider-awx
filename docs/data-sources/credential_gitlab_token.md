...
page_title: "awx_credential_gitlab_token Data Source - awx"
subcategory: ""
description: |-
  Reads an AWX GitLab Personal Access Token (gitlab_token) credential by ID or name.
---

# awx_credential_gitlab_token (Data Source)
