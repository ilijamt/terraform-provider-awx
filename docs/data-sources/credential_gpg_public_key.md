...
page_title: "awx_credential_gpg_public_key Data Source - awx"
subcategory: ""
description: |-
  Reads an AWX GPG Public Key (gpg_public_key) credential by ID or name.
---

# awx_credential_gpg_public_key (Data Source)
