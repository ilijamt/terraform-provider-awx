{{- /*
data_source_section emits the Terraform data source binding for a regular
generated resource. Caller supplies ModelConfig.ToMap() data; rendered inside
tf_object.go.tpl which provides the package + imports. Uses the dschema alias
for datasource/schema since the resource section already binds `schema` to
resource/schema.
*/ -}}
{{- define "data_source_section" -}}
